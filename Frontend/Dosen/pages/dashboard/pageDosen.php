...
<header>
    ...
    <div class="item" data-link="indexDosen.php?page=violance">
        <i class='bx bxs-mask'></i>
        <h3>Violance</h3>
        <p>Violence is presented as a deterrent against lawbreaking means of maintaining order.</p>
    </div>
    <div class="item" data-link="indexDosen.php?page=Compensation">
        <i class='bx bx-brush'></i>
        <h3>Compensation</h3>
        <p>Offering reparation or benefits to individuals affected by systemic violence or injustice.</p>
    </div>
    <div class="item" data-link="indexDosen.php?page=Rules">
        <i class='bx bx-book-bookmark'></i>
        <h3>Rules</h3>
        <p>Built on an extensive framework of laws designed to regulate nearly every aspect of daily life.</p>
    </div>
    <div class="item" data-link="indexDosen.php?page=Service">
