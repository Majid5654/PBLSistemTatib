...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($user->updatePassword($userId, $newPassword)) {
        ...
        header("Location: /PBLTatib/PBLSistemTatib/Frontend/Dosen/indexDosen.php?page=dashboard"); // Redirect to success page
        exit;
    } else {
        $_SESSION['message'] = "Failed to update password. Please try again.";
        header("Location: SettingDosen.php"); // Redirect back to change page
        exit;
    }
}
?>
